...
print(f"{'STT':<3} | {'Chi nhánh':<15} | {'Họ và tên':<24} | {'Chức danh':<8} | {'Giờ ngày (G)':<12} | {'Ngày làm ngày (J)':<18} | {'Ca đêm (K)':<10} | {'Tổng J+K':<10}")
print("-" * 115)
...
for r in range(3, 59):
    ...
    print(f"{stt:<3} | {cn:<15} | {name:<24} | {role:<8} | {g_num:<12.2f} | {j_num:<18} | {k_num:<10} | {j_num + k_num:<10}")
